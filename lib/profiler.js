...
function testProfilingProfiler(callback)
{
	...
	for (var i = 0; i < runs; i++)
	{
		...
		exports.measureFrom(start, 'fake', runs);
		exports.measureFrom(start, 'profile', runs);
	}
	var stats = exports.getStats('profile');
	testing.assert(stats.meanTimeUs < 1, 'Profiling should take less than 1 µs', callback);
...
{
	return getProfiler(key).getStats(key);
};
